...
class SingleStoryComponent32 extends StatefulWidget {
  ...
  @override
  State<SingleStoryComponent32> createState() => _SingleStoryComponent32State();
}

class _SingleStoryComponent32State extends State<SingleStoryComponent32> {
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: RotatedBox(
                        quarterTurns: 1,
                        child:VideoPlayerView(url: "Assets/s3/videos/pig-1.mp4", dataSourceType: DataSourceType.asset),
                      ),
                    ),
                    Container(
                      ...
                      child: RotatedBox(
                          quarterTurns: 1,
                          child: Center(child: Text('Oink!', style: TextStyle(fontSize: SizeConfig.screenWidth * 0.1, fontWeight: FontWeight.w900),))
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: RotatedBox(
                        quarterTurns: 1,
                        child:VideoPlayerView(url: "Assets/s3/videos/pig-2.mp4", dataSourceType: DataSourceType.asset),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(5.0),
