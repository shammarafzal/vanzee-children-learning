...
class SingleStoryComponent27 extends StatefulWidget {
  ...
  @override
  State<SingleStoryComponent27> createState() => _SingleStoryComponent27State();
}
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: RotatedBox(
                          quarterTurns: 1,
                          child: Center(child: Text('Pop!', style: TextStyle(fontSize: SizeConfig.screenWidth * 0.1, fontWeight: FontWeight.w900),))
                      ),
                    ),
                  ],
                ),
